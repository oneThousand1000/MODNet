...
if __name__ == '__main__':
    ...
    ckpt_path = 'F:/full-head-dataset/skeleton_estimation/foreground_matting_v2/MODNet-master/pretrained/modnet_webcam_portrait_matting.ckpt'
    ...
    im_paths = glob.glob('G:/full-head-dataset/final_new_crop/crop/*/*.png')
    for im_path in tqdm(im_paths):

        matte_path = im_path.replace('crop', 'matte').replace('final_new_matte', 'final_new_crop')
